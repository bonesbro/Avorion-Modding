...
meta =
{
    ...
    name = "Universal Adventuring Companion (2.2)",

    -- Title of your mod that will be displayed to players
    title = "Universal Adventuring Companion (2.2)",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a module that combines convenience features of systems into a single unit.\n\nUpdated with the new Object Scanner behavior from 2.2.\n\nAll credit goes to original mod author: Myrianne",
